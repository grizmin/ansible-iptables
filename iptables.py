...
def construct_rule(params):
    rule = []
    append_param(rule, params['policy'], '-P', False)
    append_policy(rule, params['policy_jump'])
...
def main():
    module = AnsibleModule(
        ...
        argument_spec=dict(
            ...
            policy_jump=dict(required=False, default=None, type='str'),
